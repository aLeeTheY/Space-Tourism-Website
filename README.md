...
> [!IMPORTANT]
> Информация актуальна для версии **[1.1.0](https://github.com/aLeeTheY/Space-Tourism-Website/releases/tag/1.1.0)**. На момент проверки проект корректно отображался в последних стабильных версиях всех [указанных браузеров](#поддерживаемые-браузеры).
>
> **Дата последней проверки: 16 марта 2026**
