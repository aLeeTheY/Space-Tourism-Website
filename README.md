...
> [!IMPORTANT]
> Совместимость с браузерами проверялась для версии сайта **1.0.5**. На момент проверки, сайт корректно отображался в актуальных версиях [всех вышеперечисленных браузеров](#поддерживаемые-браузеры).
>
