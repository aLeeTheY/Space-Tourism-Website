...
(() => {
  ...
  // src/ts/crew__tab_switcher.ts
  var tab_buttons = document.getElementsByClassName("tab-panel-pagination__button");
  var current_active = {
    button: document.getElementById("mId__douglas-tab-button"),
    picture: document.querySelector('.pictures__img[data-tab-name="douglas"]'),
    tab: document.querySelector('.tab-panel__tab[data-tab-name="douglas"]')
  };
