...
(() => {
  ...
  // src/ts/destination__tab_switcher.ts
  var tab_buttons = document.getElementsByClassName("tab-panel-navigation__button");
  var current_active = {
    button: document.getElementById("mId__moon-tab-button"),
    picture: document.querySelector('.pictures__img[data-tab-name="moon"]'),
    tab: document.querySelector('.tab-panel__tab[data-tab-name="moon"]')
  };
